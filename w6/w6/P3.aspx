<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="P3.aspx.cs" Inherits="w6.P3" %>
    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:Image ID="Image1" runat="server" Height="119px" Width="233px" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                        ...
                        <ItemTemplate>
                            <table class="auto-style1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Image ID="Image2" runat="server" Height="64px" ImageUrl='<%# Eval("Photo") %>' Width="88px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
